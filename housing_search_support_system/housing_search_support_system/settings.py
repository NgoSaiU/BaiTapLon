"""
Django settings for housing_search_support_system project.
...
SECRET_KEY = 'django-insecure-a$_(g5hl4pf%%=^k0c(*3jh)$&nan0k2*0#9n5k+3n%7o4h#07'
...
WSGI_APPLICATION = 'housing_search_support_system.wsgi.application'
